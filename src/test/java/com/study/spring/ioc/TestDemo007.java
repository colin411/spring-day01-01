...
import main.java.com.study.spring.ioc.demo007.Demo007Collection;
...
//        1.加载spring配置文件
        ApplicationContext context = new ClassPathXmlApplicationContext("main/resourse/ioc/bean-demo007.xml");
